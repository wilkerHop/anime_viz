...
- ✅ Any CI job fails (commitlint, checks, unit-tests, e2e-tests, or build)
- ✅ The event is a push to main (not pull requests)
- ⚠️ The workflow has proper permissions
...
**Title Format:** `🔴 CI Failure: <failed-jobs> (<short-sha>)`
...
- ✅ Immediate notification when CI breaks
...
### 3. AI-Assisted Fixes
- ✅ Copilot automatically assigned
- ✅ Can create fix PRs autonomously
- ✅ Reduces time to resolution

### 4. Audit Trail
- ✅ All failures tracked as issues
- ✅ Labels for easy filtering
- ✅ Historical record of CI health
...
4. Issue created: "🔴 CI Failure: unit-tests (abc1234)"
